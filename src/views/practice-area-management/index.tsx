...
import { PageStatusMap, PaginationSortEnum } from './constants/publicatoin-management-enum';
...
const PracticeArea = () => {
    ...
    useEffect(() => {
        if (data?.findAllPracticeAreas?.data) {
            setRows(data.findAllPracticeAreas.data);
            setCount(data.findAllPracticeAreas.pagination.total);
        }
    }, [data?.findAllPracticeAreas?.data]);
            ...
            title={
                <Grid container justifyContent={{ md: 'space-between' }} alignItems={{ md: 'center' }} spacing={2}>
                    <Grid item xs={12} md={5}>
                        <Typography variant="h2">Practice Area Management</Typography>
                    </Grid>
                                                            ...
                                                            <>
                                                                ...
                                                                <Menu {...bindMenu(popupState)}>
                                                                    <MenuItem
                                                                        ...
                                                                        onClick={() => {
                                                                            navigate(`${PracticeAreaPath}/edit/${row._id}`);
                                                                        }}
                                                                    >
                                                                        Edit
                                                                    </MenuItem>
