        ...
        <>
            {!isHorizontal ? (
                <ListItemButton
                    ...
                    to={item.url!}
                    target={itemTarget}
                    disabled={!item?.roles?.some((role) => userDetails?.role?.includes(role))}
                    ...
                    <ButtonBase aria-label="theme-icon" sx={{ borderRadius: `${borderRadius}px` }} disableRipple={drawerOpen}>
                        <ListItemIcon
                            sx={{
                                ...
                                color: mode === ThemeMode.DARK ? '#8ec3ec' : theme.palette.background.paper,
                ...
                <ListItemButton
                    ...
                    sx={{
                        ...
                        // backgroundColor: level > 1 e.palette.primary.light, 0.5) : 'inherit',
                        py: 1,
                        pl: 2,
                        mr: isParents ? 1 : 0
                    }}
