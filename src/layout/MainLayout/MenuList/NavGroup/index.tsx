            ...
            {!isHorizontal ? (
                <>
                    <List
                        ...
                        //Sub heading is usally not require please uncomment and use if required in future
                        // subheader={
                        //     currentItem.title &&
                        //     drawerOpen && (
                    ...
                    >
                        ...
                        {!openMini ? (
                            <IconChevronDown
                                stroke={1.5}
                                size="16px"
                                color={mode === ThemeMode.DARK ? theme.palette.secondary.light : theme.palette.text.dark}
                            />
                        ) : (
                            <IconChevronDown
                                stroke={1.5}
