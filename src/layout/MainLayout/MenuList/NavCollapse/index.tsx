...
const NavCollapse = ({ menu, level, parentId }: NavCollapseProps) => {
    ...
    const collapseIcon = drawerOpen ? (
        <IconChevronUp stroke={1.5} size="16px" style={{ marginTop: 'auto', marginBottom: 'auto', position: 'absolute', right: 10 }} />
    ) : (
        <IconChevronRight stroke={1.5} size="16px" style={{ marginTop: 'auto', marginBottom: 'auto', position: 'absolute', right: 10 }} />
    );
                ...
                <>
                    <ListItemButton
                        sx={{
                            ...
                            ...(drawerOpen &&
                                level === 1 &&
                                mode !== ThemeMode.DARK && {
                                    '&:hover': { bgcolor: lighten(theme.palette.primary.main, 0.5) },
                                    '&.Mui-selected': {
                                        bgcolor: lighten(theme.palette.primary.main, 0.5),
                                        color: iconSelectedColor,
                                        '&:hover': { color: iconSelectedColor, bgcolor: lighten(theme.palette.primary.main, 0.5) }
                                    }
                                }),
                            ...
                            ...((!drawerOpen || level !== 1) && {
                                ...
                                '&.Mui-selected': {
                                    '&:hover': { bgcolor: theme.palette.primary.light },
                                    bgcolor: mode === ThemeMode.DARK ? alpha(theme.palette.primary.main, 0.16) : theme.palette.primary.light
                                }
                            }),
                        }}
                        selected={isSelected}
                    ...
                    >
                        ...
                        {openMini || open ? (
                            ...
                            <IconChevronDown stroke={1.5} size="16px" style={{ marginTop: 'auto', marginBottom: 'auto', position: 'absolute', right: 10 }} />
                        )}
